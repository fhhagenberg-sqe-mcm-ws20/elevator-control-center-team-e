...
import at.fhhagenberg.sqe.ui.floor.ServicedFloorViewModel
import at.fhhagenberg.sqe.ui.floor.ServicedFloorViewModelImpl
...
class ViewModelsModule : AbstractModule() {
    override fun configure() {
        ...
        bind(ServicedFloorViewModel::class.java).to(ServicedFloorViewModelImpl::class.java)
